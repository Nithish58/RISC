...
/**
 * This class tests various commands and functionalities of the
 * AttackGameController.
 * 
 * @author Bikash
 */
...
public class AttackGameControllerTest {
	...
	/**
	 * Method called before each test case Instantiates necessary objects and loads
	 * a valid map, adds 3 players, populates countries, places armies, then skips
	 * reinforcement and attack phase and goes directly to fortification phase.
	 */
	@Before
	...
	/**
	 * Tests a valid attack command on the AttackGameController It returns true if
	 * the game state after the command is executed is "fortify"
	 * 
	 * @throws Exception on invalid
	 */
	@Test
	public void test001_validAttackCommand() throws Exception {
	...
	/**
	 * The expected game state is "fortify" It returns true if the game state after
	 * the method is called is "fortify"
	 */
	@Test
	public void test002_endAttack() {
		String expected = "fortify";
	...
	public void loadValidMap(String mapName) {
		...
		phaseViewTest.receiveCommand("exitloadgame"); // Edit loadgame phase
